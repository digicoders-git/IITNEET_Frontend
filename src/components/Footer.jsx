        ...
        <footer className="bg-blue-900 text-blue-200 pt-12 pb-6">
            <div className="page-container">
                ...
                <div className="border-t border-blue-800 pt-6 flex flex-col md:flex-row justify-between items-center gap-3 text-sm">
                    <p><span className="text-white font-semibold">&copy;</span> 2026 iitneet.com — crafted with ❤️ by <a href="https://digicoders.in/" target="_blank" rel="noopener noreferrer" className="text-amber-400 hover:text-white transition-colors font-bold">#Team digicoders</a></p>
