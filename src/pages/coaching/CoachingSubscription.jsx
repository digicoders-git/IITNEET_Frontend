...
import {
    ...
    CalendarCheck, RefreshCw, Users, IndianRupee, ShieldCheck, Loader2, Megaphone, X
} from 'lucide-react';
...
const CoachingSubscription = () => {
    ...
    const COACHING_PLAN = {
        name: 'Advertiser Membership',
        price: 2000,
        duration: 365,
        validity: '1 Year',
        features: [
            'Full advertising page for 1 year',
    ...
    const handlePurchase = async (planId = null, price = COACHING_PLAN.price, name = COACHING_PLAN.name, duration = COACHING_PLAN.duration) => {
        if (!user?.isApproved) {
    ...
    return (
        <div className="space-y-8">
            <div>
                ...
                <p className="text-slate-500 text-sm mt-1">Activate your membership to advertise publicly</p>
            </div>
                ...
                <div className="bg-emerald-50 border-2 border-emerald-200 rounded-2xl p-5 flex items-start gap-4">
                    ...
                    <div className="flex-1">
                        <h4 className="font-black text-emerald-900 text-lg">
                            Active — {currentSub.plan?.name || COACHING_PLAN.name}
                        </h4>
                ...
                <div className="bg-amber-50 border-2 border-amber-200 rounded-2xl p-5 flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-amber-700 text-sm mt-0.5">
                            Your advertisement is not visible. Purchase a plan to go live.
                        </p>
                    </div>
                </div>
            )}

            {/* Default Coaching Plan Card */}
            <div className="bg-white rounded-2xl border-2 border-blue-900 shadow-xl overflow-hidden">
                <div className="bg-gradient-to-br from-blue-900 to-indigo-900 px-8 py-8">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center">
                            <Megaphone size={26} className="text-amber-400" />
                        </div>
                        <div>
                            <p className="text-blue-300 text-xs font-black uppercase tracking-widest">Standard Plan</p>
                            <h3 className="text-2xl font-black text-white">{COACHING_PLAN.name}</h3>
                        </div>
                    </div>
                    <div className="flex items-end gap-2 mb-2">
                        <span className="text-5xl font-black text-amber-400">₹{COACHING_PLAN.price}</span>
                ...
                <div className="p-8">
                    <ul className="space-y-3 mb-8">
                        {COACHING_PLAN.features.map((f, i) => (
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-8">
                        {[
                            ...
                            { icon: Users, label: 'Reach', value: 'All Students' },
                    ...
                    >
                        {purchasing === 'default'
                            ...
                            : <><IndianRupee size={16} /> {currentSub ? 'Renew Membership — ₹2000' : 'Activate Membership — ₹2000'}</>
                        }
                    </button>
                    ...
                    <div className="bg-white rounded-[2.5rem] p-10 max-w-md w-full shadow-2xl relative border-4 border-amber-400">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-slate-500 leading-relaxed font-medium mb-8">
                                Your coaching institute is currently under review by our team. You can activate your membership once your profile has been verified. 
                                <br/><br/>
